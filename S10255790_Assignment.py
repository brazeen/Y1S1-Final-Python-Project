...
#itemgetter library will be used in option 10
...
def option10(info,carpark):
    #addresscarpark will be used to store all the data before it is written
    addresscarpark = []
    for i in info:
        #use this as a placeholder list to put all the stuff for each line
        addinglist = []
        for line in carpark:
    ...
    for lst in range(len(addresscarpark)):
        ...
        #join every list so it can be written to the csv 
...
#option 4: Print Total Number of Carparks in the File Read in [3]
    ...
    if user == 4:
        ...
        #print error message if option 3 false
            ...
            print("Please choose [3] first to read Carpark Availability Data File")
